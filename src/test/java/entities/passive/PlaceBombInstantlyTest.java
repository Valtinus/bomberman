...
public class PlaceBombInstantlyTest {
    ...
    public void testApplyEffect(){
        PlaceBombInstantly placeBombInstantly = new PlaceBombInstantly();
        placeBombInstantly.applyEffect(gameView, player);
        assertTrue(player.placeBombInstantlyActive);
